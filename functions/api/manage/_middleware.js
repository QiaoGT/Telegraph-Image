async function errorHandling(context) {
  ...
  function authentication(context) {
    ...
    if (
      (typeof context.env.img_url == "undefined" || context.env.img_url == null || context.env.img_url == "") &&
      !context.env.DB
    ) {
        return new Response('Dashboard is disabled. Please bind D1 (DB) or KV (img_url) to use this feature.', { status: 200 });
    }
